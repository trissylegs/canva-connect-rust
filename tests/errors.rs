...
fn test_api_error_code_display() {
    ...
    assert_eq!(format!("{}", ApiErrorCode::TooManyRequests), "TOO_MANY_REQUESTS");
    assert_eq!(format!("{}", ApiErrorCode::InternalServerError), "INTERNAL_SERVER_ERROR");
...
fn test_api_error_code_from_string() {
    ...
    assert_eq!(ApiErrorCode::from("FORBIDDEN".to_string()), ApiErrorCode::Forbidden);
    assert_eq!(ApiErrorCode::from("TOO_MANY_REQUESTS".to_string()), ApiErrorCode::TooManyRequests);
    assert_eq!(ApiErrorCode::from("INTERNAL_SERVER_ERROR".to_string()), ApiErrorCode::InternalServerError);
...
fn test_json_error_conversion() {
    ...
    let parse_result: std::result::Result<serde_json::Value, serde_json::Error> = serde_json::from_str(invalid_json);
